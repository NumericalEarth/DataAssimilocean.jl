# 64-GPU spinup at 1/32 degree resolution
#
# Runs a 90-day spinup using 64 GPUs via MPI (Partition 8×8).
# Saves per-rank final state and surface output.
#
# Usage:
#   srun -n 64 julia --project 64_gpu_da/spinup.jl OUTPUT_DIR [DAYS]
...
resolution = 1/32
Δt = 5minutes
substeps = 240   # 8× more substeps than 1/4 deg (grid is 8× finer)
...
rank == 0 && @info "64-GPU Spinup Configuration:"
